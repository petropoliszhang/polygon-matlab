...
developed for the discretization
...
\item a diffusion equation often serves as a synthetic accelerator or 
	...
	\cite{AdamsLarsen2002,JamesS.Warsa2004}. A discontinuous finite element technique is often employ
	in the discretization of the transport equation for unstructured and 
	polygonal/polyhedral grids \cite{Wareing_McGhee_Morel_Pautz_DGFEM2001,Warsa2008_CDFEM,
	Ragusa_Wang_NSE_2009,Bailey_MC2011,Ragusa_Wang_JCP_2011}.
  \tcr{Employing the same     ...}
\item 
\end{enumerate}
...
diffusion equation on \tcr{not FINISHED }
...
papers \cite{DouglasN.Arnold2002} for additional details. Here, we employ the Symmetric
...
In this paragraph, we describe the SIP discretization \cite{DouglasN.Arnold2002,Kanschat2007} of the 
...
\cite{amrrrr}. Adaptive Mesh Refinement (AMR) techniques require local error estimates to determine
...
monitor the interfacial jumps. Following \cite{leicht2007,Ragusa_Wang_JCP_2011}, we define 
...
manufactured solutions \cite{mms}. This time, a strongly spatially varying function is chosen
...
\centering
\subfigure[Cycle \# 12]{
\includegraphics[scale=0.25]{../pwld_diffusion/results/amr/special/amr0005}
\label{fig:amr_cycle_12}
}
\subfigure[Cycle \# 17]{
\includegraphics[scale=0.25]{../pwld_diffusion/results/amr/amr0_8_matlab_mesh_linewidth_2/amr_mms_2_threshold0_8_amr_cy25c}
\label{fig:amr_cycle_17}
}
\caption{AMR Grids .................}
...
%\include{pwld_diffusion_paper.bib}
