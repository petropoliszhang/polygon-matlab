...
allows for $C=0$ but the resulting linear system is nonsymmetric. % and cannot be tackled using a  preconditioned conjugate gradient technique.
For boundary edges, 
...
%The calculated value for $h_\perp$ may be, for extremely skewed meshes, inaccurate, leading to too small a value for the penalty coefficient.

% (not the formulas pertaining to the regular polygons). 
