...
As noted in the Introduction, one of the In this Section, we introduce Adaptive Mesh Refinement (AMR)
...
the solution of the diffusion equation is continuous, \cite{error_indic} is a
