...
\begin{figure}[H]
  \centering
  \includegraphics[width=5cm]{amr_zones}
  \caption{Amr zones.}
  \label{amr_zone}
\end{figure}
...
\begin{figure}[H]
  \centering
  \subfigure[Solution on the initial mesh.]
  {
    \includegraphics[width=0.45\linewidth]{amr_mesh_0}
    \label{amr_mesh_0}
  }
  \subfigure[Solution on the once refined mesh.]
  {
    \includegraphics[width=0.45\linewidth]{amr_mesh_1}
    \label{amr_mesh_1}
  }\\
  \subfigure[Solution on the twice refined mesh.]
  {
    \includegraphics[width=0.45\linewidth]{amr_mesh_2}
    \label{amr_mesh_2}
  }
  \subfigure[Solution on the thrice refined mesh.]
  {
    \includegraphics[width=0.45\linewidth]{amr_mesh_3}
    \label{amr_mesh_3}
  }\\
  \subfigure[Solution on the four times refined mesh.]
  {
    \includegraphics[width=0.45\linewidth]{amr_mesh_4}
    \label{amr_mesh_4}
  }
  \caption{Solution on the successively adapted meshes.}
  \label{amr_meshes}
\end{figure}  

On \Cref{amr_mesh_4}, we can see that there are quadrilaterals, pentagons, and
heptagons.
...
% COMMENTER TO ALLOW COMPILATION
