...
figure(1);
surf(x,y,ones(n+1,n+1),'FaceColor','white');
view(0,90);
...
if(logi_save_plots)
    output_file1=strcat('.\figs\smooth_quad_mesh_L',int2str(L),'_n',int2str(n),'_emb','_a',num2str(fraction,3));
...
for k=1:nc
    ...
    %%%%%%%%%%%%%%%%%%%%%
    output_file_k=strcat('.\figs\smooth_quad_mesh_L',int2str(L),...
